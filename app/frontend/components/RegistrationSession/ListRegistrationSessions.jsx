...
import CapitalizeDateDaySpanish from "~/components/RegistrationSession/Common/CapitalizeDateDaySpanish.jsx";
      ...
      <Col key={registrationSession.id}>
        <Card className="registration-session-card" bg="light" text="dark" border="dark">
          <Card.Body style={{ textAlign: "center" }}>
            <Card.Subtitle>{CapitalizeDateDaySpanish(registrationSession.date, locale)}<br />{registrationSession.start_time} — {registrationSession.end_time}</Card.Subtitle>
            <br />
