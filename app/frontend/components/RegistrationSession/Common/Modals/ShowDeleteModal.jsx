function ShowDeleteModal(type, id, setDeletePath, setDeleteMessage, setDisplayConfirmationModal, registrationSession = null) {
  if (registrationSession === null) {
    ...
    setDeleteMessage(`Are you sure you want to remove ${type.first_name} registered at ${registrationSession.location} on ${registrationSession.date} at ${registrationSession.time}`);
  }
